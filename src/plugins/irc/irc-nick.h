...
extern int irc_nick_config_colors_cb (void *data, const char *option,
                                      const char *value);
extern const char *irc_nick_find_color (const char *nickname, const char *prefix);
extern const char *irc_nick_find_color_name (const char *nickname, const char *prefix);
